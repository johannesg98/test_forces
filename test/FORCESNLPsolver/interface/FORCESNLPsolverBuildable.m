...
classdef FORCESNLPsolverBuildable < coder.ExternalDependency
    ...
    methods (Static)
        ...
        function [output,exitflag,info] = forcesInitOutputsMatlab()
            ...
            outputs_x22 = coder.nullcopy(zeros(8, 1));
            outputs_x23 = coder.nullcopy(zeros(8, 1));
            outputs_x24 = coder.nullcopy(zeros(8, 1));
            outputs_x25 = coder.nullcopy(zeros(8, 1));
    ...
    methods (Static, Access = private)
        function [output,exitflag,info] = forcesInitOutputsC()
            ...
            outputs_x22 = coder.nullcopy(double(zeros(8, 1)));
            outputs_x23 = coder.nullcopy(double(zeros(8, 1)));
            outputs_x24 = coder.nullcopy(double(zeros(8, 1)));
            outputs_x25 = coder.nullcopy(double(zeros(8, 1)));
            output = struct('x01', outputs_x01,...
                            'x02', outputs_x02,...
                            'x03', outputs_x03,...
                            'x04', outputs_x04,...
