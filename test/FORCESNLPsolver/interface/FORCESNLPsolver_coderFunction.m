...
% - x22 - column vector of length 8
% - x23 - column vector of length 8
% - x24 - column vector of length 8
% - x25 - column vector of length 8
function [x01, x02, x03, x04, x05, x06, x07, x08, x09, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, x21, x22, x23, x24, x25] = FORCESNLPsolver(xinit, x0)
